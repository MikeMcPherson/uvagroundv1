...
-- Fri 12 Oct 2018 03:35:09 PM EDT
...
CREATE TABLE IF NOT EXISTS `LibertasTest`.`libertasScience` (
  `TIMEUTC` VARCHAR(29) NOT NULL,
  `XPOS` FLOAT NULL DEFAULT NULL,
  `YPOS` FLOAT NULL DEFAULT NULL,
  `ZPOS` FLOAT NULL DEFAULT NULL,
  `NUMPVT` FLOAT NULL DEFAULT NULL,
  `PDOP` FLOAT NULL DEFAULT NULL,
  `XVEL` FLOAT NULL DEFAULT NULL,
  `YVEL` FLOAT NULL DEFAULT NULL,
  `ZVEL` FLOAT NULL DEFAULT NULL,
  `LATITUDE` FLOAT NULL DEFAULT NULL,
  `LONGITUDE` FLOAT NULL DEFAULT NULL,
  `FIXQUALITY` FLOAT NULL DEFAULT NULL,
  `NUMTRACKED` FLOAT NULL DEFAULT NULL,
