...
-- Wed 17 Oct 2018 07:39:04 PM EDT
...
CREATE TABLE IF NOT EXISTS `LibertasTest`.`libertasScience` (
  ...
  `ALTITUDE` BIGINT(20) NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `LibertasTest`.`libertasAX25Packet`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `LibertasTest`.`libertasAX25Packet` ;

CREATE TABLE IF NOT EXISTS `LibertasTest`.`libertasAX25Packet` (
  `TIMEUTC` DATETIME NULL,
  `GPSTIME` DOUBLE NULL,
  `GPSWEEK` INT NULL,
